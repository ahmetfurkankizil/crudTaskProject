...
from .views import ProjectListCreateView, ProjectRetrieveUpdateDestroyView, RepositoryListCreateView, RepositoryRetrieveUpdateDestroyView, TrackerListCreateView, TrackerRetrieveUpdateDestroyView
